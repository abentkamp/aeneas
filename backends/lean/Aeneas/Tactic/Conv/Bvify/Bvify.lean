...
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U8.UScalar_bv (x : U8) : UScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U16.UScalar_bv (x : U16) : UScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U32.UScalar_bv (x : U32) : UScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U64.UScalar_bv (x : U64) : UScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U128.UScalar_bv (x : U128) : UScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem Usize.UScalar_bv (x : Usize) : UScalar.toBitVec x = x.toBitVec := by simp

@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I8.IScalar_bv (x : I8) : IScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I16.IScalar_bv (x : I16) : IScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I32.IScalar_bv (x : I32) : IScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I64.IScalar_bv (x : I64) : IScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I128.IScalar_bv (x : I128) : IScalar.toBitVec x = x.toBitVec := by simp
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem Isize.IScalar_bv (x : Isize) : IScalar.toBitVec x = x.toBitVec := by simp

@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem UScalar.bv_setWidth (x : UScalar ty) : x.toBitVec.setWidth ty.numBits = x.toBitVec := by simp only [BitVec.setWidth_eq]

@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U8.bv_setWidth (x : U8) : x.toBitVec.setWidth 8 = x.toBitVec := UScalar.bv_setWidth x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U16.bv_setWidth (x : U16) : x.toBitVec.setWidth 16 = x.toBitVec := UScalar.bv_setWidth x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U32.bv_setWidth (x : U32) : x.toBitVec.setWidth 32 = x.toBitVec := UScalar.bv_setWidth x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U64.bv_setWidth (x : U64) : x.toBitVec.setWidth 64 = x.toBitVec := UScalar.bv_setWidth x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem U128.bv_setWidth (x : U128) : x.toBitVec.setWidth 128 = x.toBitVec := UScalar.bv_setWidth x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem Usize.bv_setWidth (x : Usize) : x.toBitVec.setWidth System.Platform.numBits = x.toBitVec := UScalar.bv_setWidth x

@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem IScalar.bv_signExtend (x : IScalar ty) : x.toBitVec.signExtend ty.numBits = x.toBitVec := by
  simp only [BitVec.signExtend, IScalar.toBitVec_toInt, IScalar.BitVec_ofInt_toInt]

@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I8.bv_signExtend (x : I8) : x.toBitVec.signExtend 8 = x.toBitVec := IScalar.bv_signExtend x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I16.bv_signExtend (x : I16) : x.toBitVec.signExtend 16 = x.toBitVec := IScalar.bv_signExtend x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I32.bv_signExtend (x : I32) : x.toBitVec.signExtend 32 = x.toBitVec := IScalar.bv_signExtend x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I64.bv_signExtend (x : I64) : x.toBitVec.signExtend 64 = x.toBitVec := IScalar.bv_signExtend x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem I128.bv_signExtend (x : I128) : x.toBitVec.signExtend 128 = x.toBitVec := IScalar.bv_signExtend x
@[simp, simp_scalar_safe, bvify, grind =, agrind =] theorem Isize.bv_signExtend (x : Isize) : x.toBitVec.signExtend System.Platform.numBits = x.toBitVec := IScalar.bv_signExtend x

@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem UScalar.cast_bv (x : UScalar ty) : (UScalar.cast tgt x).toBitVec = x.toBitVec.setWidth tgt.numBits := by
  simp
...
@[bvify]
theorem UScalar.lt_equiv_bv_lt {ty : UScalarTy} (x y : UScalar ty) : x < y ↔ x.toBitVec < y.toBitVec := by
  rw [UScalar.lt_equiv, BitVec.lt_def, UScalar.toBitVec_toNat, UScalar.toBitVec_toNat]

@[bvify]
theorem UScalar.le_equiv_bv_le {ty : UScalarTy} (x y : UScalar ty) : x ≤ y ↔ x.toBitVec ≤ y.toBitVec := by
  rw [UScalar.le_equiv, BitVec.le_def, UScalar.toBitVec_toNat, UScalar.toBitVec_toNat]
...
example
  ...
  := by
  subst_vars
  exact core.convert.num.FromU32U16.from_val_eq x
...
example
  ...
  := by
  subst_vars
  have h := UScalar.cast_val_eq (src_ty := .U32) .U16 x
  simp only [UScalarTy.numBits] at h
  omega

example (x : U64) : x.toNat >>> 31 < 2^33 := by
  have hb : x.toNat < 2^64 := by
    have := x.hBounds; simp [UScalarTy.numBits] at this; exact this
  simp only [Nat.shiftRight_eq_div_pow]
  apply Nat.div_lt_of_lt_mul
  calc x.toNat < 2^64 := hb
    _ = 2^31 * 2^33 := by norm_num
...
example (byte : U8) : 8 ∣ (byte &&& 16#u8).toNat := by
  have h : UScalar.toBitVec (byte &&& 16#u8) = byte.toBitVec &&& 16#8 :=
    UScalar.bv_and byte 16#u8
  rw [Nat.dvd_iff_mod_eq_zero, ← UScalar.toBitVec_toNat, h]
  have : ∀ b : BitVec 8, (b &&& 16#8).toNat % 8 = 0 := by decide
  exact this byte.toBitVec
