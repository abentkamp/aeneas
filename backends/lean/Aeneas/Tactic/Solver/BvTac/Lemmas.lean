...
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U8.and_zero (x : U8) : x &&& 0#u8 = 0#u8 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U16.and_zero (x : U16) : x &&& 0#u16 = 0#u16 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U32.and_zero (x : U32) : x &&& 0#u32 = 0#u32 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U64.and_zero (x : U64) : x &&& 0#u64 = 0#u64 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U128.and_zero (x : U128) : x &&& 0#u128 = 0#u128 := by grind

-- 0 &&& x = 0
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U8.zero_and (x : U8) : 0#u8 &&& x = 0#u8 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U16.zero_and (x : U16) : 0#u16 &&& x = 0#u16 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U32.zero_and (x : U32) : 0#u32 &&& x = 0#u32 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U64.zero_and (x : U64) : 0#u64 &&& x = 0#u64 := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U128.zero_and (x : U128) : 0#u128 &&& x = 0#u128 := by grind
...
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U8.or_zero (x : U8) : x ||| 0#u8 = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U16.or_zero (x : U16) : x ||| 0#u16 = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U32.or_zero (x : U32) : x ||| 0#u32 = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U64.or_zero (x : U64) : x ||| 0#u64 = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U128.or_zero (x : U128) : x ||| 0#u128 = x := by grind

-- 0 ||| x = x
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U8.zero_or (x : U8) : 0#u8 ||| x = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U16.zero_or (x : U16) : 0#u16 ||| x = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U32.zero_or (x : U32) : 0#u32 ||| x = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U64.zero_or (x : U64) : 0#u64 ||| x = x := by grind
@[simp, simp_scalar_safe, bvify, grind =, agrind =]
theorem U128.zero_or (x : U128) : 0#u128 ||| x = x := by grind
