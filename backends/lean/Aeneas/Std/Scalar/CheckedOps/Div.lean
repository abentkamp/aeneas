...
theorem «%S».checked_div_bv_spec (x y : «%S») :
  ...
  cases h: core.num.checked_div_UScalar x y <;> simp_all <;> trivial
...
theorem «%S».checked_div_bv_spec (x y : «%S») :
  ...
  cases h: core.num.checked_div_IScalar x y <;>
    simp_all only [ne_eq, not_false_eq_true, and_self, true_and] <;> trivial
